                ...
                >
                    ...
                    >
                        ...
                        <p class="mb-4 text-[#706f6c] dark:text-[#A1A09A]">
                            Your simple and secure platform to send and receive money instantly.<br />
                            With Mini Wallet, you can manage your balance, view your transaction history, and transfer funds to other users with ease.
                        </p>
                        <ul class="mb-4 list-disc pl-5">
                            <li>Check your current balance at a glance</li>
                            <li>View all your incoming and outgoing transactions</li>
                            <li>Send money to other users quickly and securely</li>
                            <li>Get instant updates as soon as you receive or send funds</li>
                        </ul>
                        <p class="mb-4">
                            Ready to get started? Register, log in and send your first transfer now!
                        </p>
                        <div>
                            <span class="font-semibold text-[#f53003] dark:text-[#FF4433]">Tip:</span>
                            &nbsp;All transfers are processed in real time, so think twice before you press the "Send transaction" button.
                        </div>
                    </div>
                    <div
